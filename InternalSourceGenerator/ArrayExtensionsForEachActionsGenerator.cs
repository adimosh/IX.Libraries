...
public class ArrayExtensionsForEachActionsGenerator : ISourceGenerator
{
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        void WriteXmlDocRemarks(params string[] remarks)
        {
            arrayExtensionsStringBuilder.AppendLine($"{currentIndentation}/// <remarks>");
            foreach (var remark in remarks)
            {
                arrayExtensionsStringBuilder.AppendLine($"{currentIndentation}///     <para>{remark}</para>");
            }
            arrayExtensionsStringBuilder.AppendLine($"{currentIndentation}/// </remarks>");
        }
        ...
        for (var i = 1; i <= numberOfParametersToDealWith; i++)
        {
            ...
            // Method 3: ForEachAsync with ValueTask
            // =====================================
            ...
            arrayExtensionsStringBuilder.AppendLine(", ValueTask> action,");
