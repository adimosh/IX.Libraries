...
public static partial class ArrayExtensions
{
    ...
    extension(Array array)
    {
        ...
        ///     A 32-bit integer that represents the index in the <paramref name="array" /> at which
        ///     copying begins.
        /// </param>
    ...
    extension<T>(T[] array)
    {
        ...
        /// </summary>
        public void Sort() => Array.Sort((Array)array);
    }
    ...
    extension<T>(T[] array)
    {
        ...
        /// </param>
        public void Sort<TValue>(TValue[] items) =>
            Array.Sort(
                (Array)array,
                (Array?)items);
    ...
    extension(Array keys)
    {
        ...
        /// </summary>
        public void Sort() => Array.Sort(keys);
